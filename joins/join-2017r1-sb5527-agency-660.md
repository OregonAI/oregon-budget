...
jurisdiction: oregon
id: join-2017r1-sb5527-agency-660
title: 2017 Regular Session Senate Bill 5527 → agency 660 spending, FY2019–FY2019
doc_type: dataset_doc
citation: 'Join: 2017 Regular Session Senate Bill 5527 to Oregon Agency Expenditures agency 660'
...
joins:
- document_id: expenditures-660-fy2019
  dataset: expenditures
  key: agency=660;fiscal_year=2019
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-660
- unreviewed
appropriation_document: appropriations-2017r1-sb5527
...
# 2017 Regular Session Senate Bill 5527 → agency 660

## At a glance

2017 Regular Session Senate Bill 5527 appropriates to **Land Conservation and Development Department** (budget agency code `660`, registry slug `land-conservation-and-development-department`) for the **biennium beginning 2017**, which on the stated fiscal-year convention covers **FY2019–FY2019**.

In those fiscal years that agency recorded **$4,448,822.57** of spending across 390 transactions and 188 distinct payees.
...
- Appropriation figures: `appropriations-2017r1-sb5527` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2017r1-sb5527` in the `oregon-legislature` corpus, referenced not copied.
