...
jurisdiction: oregon
id: join-2019r1-sb536-agency-603
title: 2019 Regular Session Senate Bill 536 → agency 603 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 536 to Oregon Agency Expenditures agency 603'
...
relationships:
  ...
  implemented_by: []
  references_external:
  - 2019 Regular Session Senate Bill 536
  related:
  - appropriations-2019r1-sb536
...
- agency-603
- unreviewed
appropriation_document: appropriations-2019r1-sb536
sibling_corpus: oregon-legislature
sibling_document_id: measure-2019r1-sb536
agency_code: '603'
...
# 2019 Regular Session Senate Bill 536 → agency 603

## At a glance

2019 Regular Session Senate Bill 536 appropriates to **Department of Agriculture** (budget agency code `603`, registry slug `department-of-agriculture`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.
...
- Appropriation figures: `appropriations-2019r1-sb536` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb536` in the `oregon-legislature` corpus, referenced not copied.
