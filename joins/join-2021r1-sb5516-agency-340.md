...
jurisdiction: oregon
id: join-2021r1-sb5516-agency-340
title: 2021 Regular Session Senate Bill 5516 → agency 340 spending, FY2022–FY2023
doc_type: dataset_doc
citation: 'Join: 2021 Regular Session Senate Bill 5516 to Oregon Agency Expenditures agency 340'
...
joins:
- document_id: expenditures-340-fy2022
  dataset: expenditures
  key: agency=340;fiscal_year=2022
- document_id: expenditures-340-fy2023
  dataset: expenditures
  key: agency=340;fiscal_year=2023
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-340
- unreviewed
appropriation_document: appropriations-2021r1-sb5516
...
# 2021 Regular Session Senate Bill 5516 → agency 340

## At a glance

2021 Regular Session Senate Bill 5516 appropriates to **Department of Environmental Quality** (budget agency code `340`, registry slug `department-of-environmental-quality`) for the **biennium beginning 2021**, which on the stated fiscal-year convention covers **FY2022–FY2023**.

In those fiscal years that agency recorded **$222,064,194.70** of spending across 3,480 transactions and 1,146 distinct payees.
...
|---|---:|
| FY2022 | $109,270,572.01 |
| FY2023 | $112,793,622.69 |

## Provenance

- Appropriation figures: `appropriations-2021r1-sb5516` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2021r1-sb5516` in the `oregon-legislature` corpus, referenced not copied.
