...
jurisdiction: oregon
id: join-2019r1-hb2650-agency-248
title: 2019 Regular Session House Bill 2650 → agency 248 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session House Bill 2650 to Oregon Agency Expenditures agency 248'
...
joins:
- document_id: expenditures-248-fy2020
  dataset: expenditures
  key: agency=248;fiscal_year=2020
- document_id: expenditures-248-fy2021
  dataset: expenditures
  key: agency=248;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
  - 2019 Regular Session House Bill 2650
  related:
  - appropriations-2019r1-hb2650
...
- agency-248
- unreviewed
appropriation_document: appropriations-2019r1-hb2650
sibling_corpus: oregon-legislature
sibling_document_id: measure-2019r1-hb2650
agency_code: '248'
...
# 2019 Regular Session House Bill 2650 → agency 248

## At a glance

2019 Regular Session House Bill 2650 appropriates to **Oregon Military Department** (budget agency code `248`, registry slug `oregon-military-department`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$671,668,808.27** of spending across 4,692 transactions and 2,492 distinct payees.
...
|---|---:|
| FY2020 | $155,398,286.04 |
| FY2021 | $516,270,522.23 |

## Provenance

- Appropriation figures: `appropriations-2019r1-hb2650` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-hb2650` in the `oregon-legislature` corpus, referenced not copied.
