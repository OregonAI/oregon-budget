...
jurisdiction: oregon
id: join-2019r1-sb5525-agency-443
title: 2019 Regular Session Senate Bill 5525 → agency 443 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 5525 to Oregon Agency Expenditures agency 443'
...
joins:
- document_id: expenditures-443-fy2020
  dataset: expenditures
  key: agency=443;fiscal_year=2020
- document_id: expenditures-443-fy2021
  dataset: expenditures
  key: agency=443;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-443
- unreviewed
appropriation_document: appropriations-2019r1-sb5525
...
# 2019 Regular Session Senate Bill 5525 → agency 443

## At a glance

2019 Regular Session Senate Bill 5525 appropriates to **Oregon Health Authority** (budget agency code `443`, registry slug `oregon-health-authority`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$6,555,701,157.63** of spending across 12,312 transactions and 4,388 distinct payees.
...
|---|---:|
| FY2020 | $3,073,353,183.11 |
| FY2021 | $3,482,347,974.52 |

## Provenance

- Appropriation figures: `appropriations-2019r1-sb5525` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb5525` in the `oregon-legislature` corpus, referenced not copied.
