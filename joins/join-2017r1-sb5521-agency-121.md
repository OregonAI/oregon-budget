...
jurisdiction: oregon
id: join-2017r1-sb5521-agency-121
title: 2017 Regular Session Senate Bill 5521 → agency 121 spending, FY2019–FY2019
doc_type: dataset_doc
citation: 'Join: 2017 Regular Session Senate Bill 5521 to Oregon Agency Expenditures agency 121'
...
joins:
- document_id: expenditures-121-fy2019
  dataset: expenditures
  key: agency=121;fiscal_year=2019
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-121
- unreviewed
appropriation_document: appropriations-2017r1-sb5521
...
# 2017 Regular Session Senate Bill 5521 → agency 121

## At a glance

2017 Regular Session Senate Bill 5521 appropriates to **Office of the Governor** (budget agency code `121`, registry slug `office-of-the-governor`) for the **biennium beginning 2017**, which on the stated fiscal-year convention covers **FY2019–FY2019**.

In those fiscal years that agency recorded **$4,852,901.64** of spending across 497 transactions and 129 distinct payees.
...
- Appropriation figures: `appropriations-2017r1-sb5521` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2017r1-sb5521` in the `oregon-legislature` corpus, referenced not copied.
