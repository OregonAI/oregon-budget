...
jurisdiction: oregon
id: join-2023r1-hb5031-agency-248
title: 2023 Regular Session House Bill 5031 → agency 248 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session House Bill 5031 to Oregon Agency Expenditures agency 248'
...
joins:
- document_id: expenditures-248-fy2024
  dataset: expenditures
  key: agency=248;fiscal_year=2024
- document_id: expenditures-248-fy2025
  dataset: expenditures
  key: agency=248;fiscal_year=2025
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-248
- unreviewed
appropriation_document: appropriations-2023r1-hb5031
...
# 2023 Regular Session House Bill 5031 → agency 248

## At a glance

2023 Regular Session House Bill 5031 appropriates to **Oregon Military Department** (budget agency code `248`, registry slug `oregon-military-department`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.

In those fiscal years that agency recorded **$179,099,490.78** of spending across 3,403 transactions and 1,294 distinct payees.
...
|---|---:|
| FY2024 | $90,444,635.99 |
| FY2025 | $88,654,854.79 |

## Provenance

- Appropriation figures: `appropriations-2023r1-hb5031` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-hb5031` in the `oregon-legislature` corpus, referenced not copied.
