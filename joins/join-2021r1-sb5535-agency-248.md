...
jurisdiction: oregon
id: join-2021r1-sb5535-agency-248
title: 2021 Regular Session Senate Bill 5535 → agency 248 spending, FY2022–FY2023
doc_type: dataset_doc
citation: 'Join: 2021 Regular Session Senate Bill 5535 to Oregon Agency Expenditures agency 248'
...
joins:
- document_id: expenditures-248-fy2022
  dataset: expenditures
  key: agency=248;fiscal_year=2022
- document_id: expenditures-248-fy2023
  dataset: expenditures
  key: agency=248;fiscal_year=2023
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-248
- unreviewed
appropriation_document: appropriations-2021r1-sb5535
...
# 2021 Regular Session Senate Bill 5535 → agency 248

## At a glance

2021 Regular Session Senate Bill 5535 appropriates to **Oregon Military Department** (budget agency code `248`, registry slug `oregon-military-department`) for the **biennium beginning 2021**, which on the stated fiscal-year convention covers **FY2022–FY2023**.

In those fiscal years that agency recorded **$435,158,813.51** of spending across 4,033 transactions and 1,722 distinct payees.
...
|---|---:|
| FY2022 | $294,650,839.38 |
| FY2023 | $140,507,974.13 |

## Provenance

- Appropriation figures: `appropriations-2021r1-sb5535` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2021r1-sb5535` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `oregon-military-department` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `budget_agency_code: 248`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
