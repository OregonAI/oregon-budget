...
jurisdiction: oregon
id: join-2019r1-sb5531-agency-399
title: 2019 Regular Session Senate Bill 5531 → agency 399 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 5531 to Oregon Agency Expenditures agency 399'
...
joins:
- document_id: expenditures-399-fy2020
  dataset: expenditures
  key: agency=399;fiscal_year=2020
- document_id: expenditures-399-fy2021
  dataset: expenditures
  key: agency=399;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
  - 2019 Regular Session Senate Bill 5531
  related:
  - appropriations-2019r1-sb5531
...
- agency-399
- unreviewed
appropriation_document: appropriations-2019r1-sb5531
sibling_corpus: oregon-legislature
sibling_document_id: measure-2019r1-sb5531
agency_code: '399'
...
# 2019 Regular Session Senate Bill 5531 → agency 399

## At a glance

2019 Regular Session Senate Bill 5531 appropriates to **Psychiatric Security Review Board** (budget agency code `399`, registry slug `psychiatric-security-review-board`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$528,486.33** of spending across 95 transactions and 48 distinct payees.
...
- Appropriation figures: `appropriations-2019r1-sb5531` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb5531` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `psychiatric-security-review-board` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 399`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
