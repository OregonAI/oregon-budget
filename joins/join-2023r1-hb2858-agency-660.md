...
jurisdiction: oregon
id: join-2023r1-hb2858-agency-660
title: 2023 Regular Session House Bill 2858 → agency 660 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session House Bill 2858 to Oregon Agency Expenditures agency 660'
...
joins:
- document_id: expenditures-660-fy2024
  dataset: expenditures
  key: agency=660;fiscal_year=2024
- document_id: expenditures-660-fy2025
  dataset: expenditures
  key: agency=660;fiscal_year=2025
relationships:
  implements: []
  implemented_by: []
  references_external:
  - 2023 Regular Session House Bill 2858
  related:
  - appropriations-2023r1-hb2858
...
- agency-660
- unreviewed
appropriation_document: appropriations-2023r1-hb2858
sibling_corpus: oregon-legislature
sibling_document_id: measure-2023r1-hb2858
agency_code: '660'
...
# 2023 Regular Session House Bill 2858 → agency 660

## At a glance

2023 Regular Session House Bill 2858 appropriates to **Land Conservation and Development Department** (budget agency code `660`, registry slug `land-conservation-and-development-department`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.

In those fiscal years that agency recorded **$19,521,909.59** of spending across 819 transactions and 316 distinct payees.
...
|---|---:|
| FY2024 | $6,435,441.51 |
| FY2025 | $13,086,468.08 |

## Provenance

- Appropriation figures: `appropriations-2023r1-hb2858` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-hb2858` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `land-conservation-and-development-department` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 660`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
