...
jurisdiction: oregon
id: join-2019r1-sb5528-agency-255
title: 2019 Regular Session Senate Bill 5528 → agency 255 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 5528 to Oregon Agency Expenditures agency 255'
...
joins:
- document_id: expenditures-255-fy2020
  dataset: expenditures
  key: agency=255;fiscal_year=2020
- document_id: expenditures-255-fy2021
  dataset: expenditures
  key: agency=255;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
  - 2019 Regular Session Senate Bill 5528
  related:
  - appropriations-2019r1-sb5528
...
- agency-255
- unreviewed
appropriation_document: appropriations-2019r1-sb5528
sibling_corpus: oregon-legislature
sibling_document_id: measure-2019r1-sb5528
agency_code: '255'
...
# 2019 Regular Session Senate Bill 5528 → agency 255

## At a glance

2019 Regular Session Senate Bill 5528 appropriates to **Board of Parole and Post-Prison Supervision** (budget agency code `255`, registry slug `board-of-parole-and-post-prison-supervision`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$2,976,948.55** of spending across 201 transactions and 77 distinct payees.
...
- Appropriation figures: `appropriations-2019r1-sb5528` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb5528` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `board-of-parole-and-post-prison-supervision` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `budget_agency_code: 255`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
