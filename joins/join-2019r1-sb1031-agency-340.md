...
jurisdiction: oregon
id: join-2019r1-sb1031-agency-340
title: 2019 Regular Session Senate Bill 1031 → agency 340 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 1031 to Oregon Agency Expenditures agency 340'
...
joins:
- document_id: expenditures-340-fy2020
  dataset: expenditures
  key: agency=340;fiscal_year=2020
- document_id: expenditures-340-fy2021
  dataset: expenditures
  key: agency=340;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
  - 2019 Regular Session Senate Bill 1031
  related:
  - appropriations-2019r1-sb1031
...
- agency-340
- unreviewed
appropriation_document: appropriations-2019r1-sb1031
sibling_corpus: oregon-legislature
sibling_document_id: measure-2019r1-sb1031
agency_code: '340'
...
# 2019 Regular Session Senate Bill 1031 → agency 340

## At a glance

2019 Regular Session Senate Bill 1031 appropriates to **Department of Environmental Quality** (budget agency code `340`, registry slug `department-of-environmental-quality`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$248,337,534.51** of spending across 3,764 transactions and 1,258 distinct payees.
...
|---|---:|
| FY2020 | $123,487,127.54 |
| FY2021 | $124,850,406.97 |

## Provenance

- Appropriation figures: `appropriations-2019r1-sb1031` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb1031` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `department-of-environmental-quality` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 340`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
