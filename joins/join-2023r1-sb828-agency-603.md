...
jurisdiction: oregon
id: join-2023r1-sb828-agency-603
title: 2023 Regular Session Senate Bill 828 → agency 603 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session Senate Bill 828 to Oregon Agency Expenditures agency 603'
...
relationships:
  ...
  implemented_by: []
  references_external:
  - 2023 Regular Session Senate Bill 828
  related:
  - appropriations-2023r1-sb828
...
- agency-603
- unreviewed
appropriation_document: appropriations-2023r1-sb828
sibling_corpus: oregon-legislature
sibling_document_id: measure-2023r1-sb828
agency_code: '603'
...
# 2023 Regular Session Senate Bill 828 → agency 603

## At a glance

2023 Regular Session Senate Bill 828 appropriates to **Department of Agriculture** (budget agency code `603`, registry slug `department-of-agriculture`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.
...
- Appropriation figures: `appropriations-2023r1-sb828` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-sb828` in the `oregon-legislature` corpus, referenced not copied.
