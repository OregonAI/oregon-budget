...
jurisdiction: oregon
id: join-2023r1-sb431-agency-730
title: 2023 Regular Session Senate Bill 431 → agency 730 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session Senate Bill 431 to Oregon Agency Expenditures agency 730'
...
relationships:
  ...
  implemented_by: []
  references_external:
  - 2023 Regular Session Senate Bill 431
  related:
  - appropriations-2023r1-sb431
...
- agency-730
- unreviewed
appropriation_document: appropriations-2023r1-sb431
sibling_corpus: oregon-legislature
sibling_document_id: measure-2023r1-sb431
agency_code: '730'
...
# 2023 Regular Session Senate Bill 431 → agency 730

## At a glance

2023 Regular Session Senate Bill 431 appropriates to **Department of Transportation** (budget agency code `730`, registry slug `department-of-transportation`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.
...
- Appropriation figures: `appropriations-2023r1-sb431` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-sb431` in the `oregon-legislature` corpus, referenced not copied.
