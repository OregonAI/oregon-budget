...
jurisdiction: oregon
id: join-2023r1-sb5525-agency-443
title: 2023 Regular Session Senate Bill 5525 → agency 443 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session Senate Bill 5525 to Oregon Agency Expenditures agency 443'
...
joins:
- document_id: expenditures-443-fy2024
  dataset: expenditures
  key: agency=443;fiscal_year=2024
- document_id: expenditures-443-fy2025
  dataset: expenditures
  key: agency=443;fiscal_year=2025
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-443
- unreviewed
appropriation_document: appropriations-2023r1-sb5525
...
# 2023 Regular Session Senate Bill 5525 → agency 443

## At a glance

2023 Regular Session Senate Bill 5525 appropriates to **Oregon Health Authority** (budget agency code `443`, registry slug `oregon-health-authority`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.

In those fiscal years that agency recorded **$9,163,174,817.00** of spending across 16,680 transactions and 4,722 distinct payees.
...
|---|---:|
| FY2024 | $4,431,973,862.44 |
| FY2025 | $4,731,200,954.56 |

## Provenance

- Appropriation figures: `appropriations-2023r1-sb5525` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-sb5525` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `oregon-health-authority` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 443`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
