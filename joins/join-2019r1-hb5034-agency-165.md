...
jurisdiction: oregon
id: join-2019r1-hb5034-agency-165
title: 2019 Regular Session House Bill 5034 → agency 165 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session House Bill 5034 to Oregon Agency Expenditures agency 165'
...
joins:
- document_id: expenditures-165-fy2020
  dataset: expenditures
  key: agency=165;fiscal_year=2020
- document_id: expenditures-165-fy2021
  dataset: expenditures
  key: agency=165;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-165
- unreviewed
appropriation_document: appropriations-2019r1-hb5034
...
# 2019 Regular Session House Bill 5034 → agency 165

## At a glance

2019 Regular Session House Bill 5034 appropriates to **Secretary of State** (budget agency code `165`, registry slug `secretary-of-state`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$28,007,158.62** of spending across 815 transactions and 300 distinct payees.
...
|---|---:|
| FY2020 | $12,721,313.63 |
| FY2021 | $15,285,844.99 |

## Provenance

- Appropriation figures: `appropriations-2019r1-hb5034` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-hb5034` in the `oregon-legislature` corpus, referenced not copied.
