...
- Agency identity: `oregon-department-of-education-early-learning-division` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `budget_agency_code: 588`.
