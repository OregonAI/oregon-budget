...
jurisdiction: oregon
id: join-2023r1-hb5013-agency-588
title: 2023 Regular Session House Bill 5013 → agency 588 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session House Bill 5013 to Oregon Agency Expenditures agency 588'
...
- agency-588
- unreviewed
appropriation_document: appropriations-2023r1-hb5013
...
# 2023 Regular Session House Bill 5013 → agency 588

## At a glance

2023 Regular Session House Bill 5013 appropriates to **Oregon Department of Education, Early Learning Division** (budget agency code `588`, registry slug `oregon-department-of-education-early-learning-division`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.
...
- Appropriation figures: `appropriations-2023r1-hb5013` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-hb5013` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `oregon-department-of-education-early-learning-division` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `budget_agency_code: 588`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
