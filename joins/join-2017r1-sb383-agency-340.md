...
jurisdiction: oregon
id: join-2017r1-sb383-agency-340
title: 2017 Regular Session Senate Bill 383 → agency 340 spending, FY2019–FY2019
doc_type: dataset_doc
citation: 'Join: 2017 Regular Session Senate Bill 383 to Oregon Agency Expenditures agency 340'
...
relationships:
  ...
  implemented_by: []
  references_external:
  - 2017 Regular Session Senate Bill 383
  related:
  - appropriations-2017r1-sb383
...
- agency-340
- unreviewed
appropriation_document: appropriations-2017r1-sb383
sibling_corpus: oregon-legislature
sibling_document_id: measure-2017r1-sb383
agency_code: '340'
...
# 2017 Regular Session Senate Bill 383 → agency 340

## At a glance

2017 Regular Session Senate Bill 383 appropriates to **Department of Environmental Quality** (budget agency code `340`, registry slug `department-of-environmental-quality`) for the **biennium beginning 2017**, which on the stated fiscal-year convention covers **FY2019–FY2019**.
...
- Appropriation figures: `appropriations-2017r1-sb383` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2017r1-sb383` in the `oregon-legislature` corpus, referenced not copied.
