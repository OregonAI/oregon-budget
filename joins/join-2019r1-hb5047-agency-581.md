...
jurisdiction: oregon
id: join-2019r1-hb5047-agency-581
title: 2019 Regular Session House Bill 5047 → agency 581 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session House Bill 5047 to Oregon Agency Expenditures agency 581'
...
joins:
- document_id: expenditures-581-fy2020
  dataset: expenditures
  key: agency=581;fiscal_year=2020
- document_id: expenditures-581-fy2021
  dataset: expenditures
  key: agency=581;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-581
- unreviewed
appropriation_document: appropriations-2019r1-hb5047
...
# 2019 Regular Session House Bill 5047 → agency 581

## At a glance

2019 Regular Session House Bill 5047 appropriates to **Oregon Department of Education** (budget agency code `581`, registry slug `oregon-department-of-education`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$21,182,470,480.47** of spending across 6,888 transactions and 2,884 distinct payees.
...
|---|---:|
| FY2020 | $10,105,217,611.18 |
| FY2021 | $11,077,252,869.29 |

## Provenance

- Appropriation figures: `appropriations-2019r1-hb5047` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-hb5047` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `oregon-department-of-education` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 581`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
