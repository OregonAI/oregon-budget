...
jurisdiction: oregon
id: join-2021r1-sb207-agency-121
title: 2021 Regular Session Senate Bill 207 → agency 121 spending, FY2022–FY2023
doc_type: dataset_doc
citation: 'Join: 2021 Regular Session Senate Bill 207 to Oregon Agency Expenditures agency 121'
...
joins:
- document_id: expenditures-121-fy2022
  dataset: expenditures
  key: agency=121;fiscal_year=2022
- document_id: expenditures-121-fy2023
  dataset: expenditures
  key: agency=121;fiscal_year=2023
relationships:
  implements: []
  implemented_by: []
  references_external:
  - 2021 Regular Session Senate Bill 207
  related:
  - appropriations-2021r1-sb207
...
- agency-121
- unreviewed
appropriation_document: appropriations-2021r1-sb207
sibling_corpus: oregon-legislature
sibling_document_id: measure-2021r1-sb207
agency_code: '121'
...
# 2021 Regular Session Senate Bill 207 → agency 121

## At a glance

2021 Regular Session Senate Bill 207 appropriates to **Office of the Governor** (budget agency code `121`, registry slug `office-of-the-governor`) for the **biennium beginning 2021**, which on the stated fiscal-year convention covers **FY2022–FY2023**.

In those fiscal years that agency recorded **$6,393,504.69** of spending across 759 transactions and 162 distinct payees.
...
- Appropriation figures: `appropriations-2021r1-sb207` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2021r1-sb207` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `office-of-the-governor` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 121`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
