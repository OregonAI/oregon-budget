...
jurisdiction: oregon
id: join-2023r1-sb5539-agency-691
title: 2023 Regular Session Senate Bill 5539 → agency 691 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session Senate Bill 5539 to Oregon Agency Expenditures agency 691'
...
joins:
- document_id: expenditures-691-fy2024
  dataset: expenditures
  key: agency=691;fiscal_year=2024
- document_id: expenditures-691-fy2025
  dataset: expenditures
  key: agency=691;fiscal_year=2025
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-691
- unreviewed
appropriation_document: appropriations-2023r1-sb5539
...
# 2023 Regular Session Senate Bill 5539 → agency 691

## At a glance

2023 Regular Session Senate Bill 5539 appropriates to **Oregon Watershed Enhancement Board** (budget agency code `691`, registry slug `oregon-watershed-enhancement-board`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.

In those fiscal years that agency recorded **$160,502,251.13** of spending across 712 transactions and 303 distinct payees.
...
|---|---:|
| FY2024 | $75,021,868.92 |
| FY2025 | $85,480,382.21 |

## Provenance

- Appropriation figures: `appropriations-2023r1-sb5539` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-sb5539` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `oregon-watershed-enhancement-board` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `budget_agency_code: 691`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
