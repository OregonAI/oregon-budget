...
jurisdiction: oregon
id: join-2019r1-sb5504-agency-291
title: 2019 Regular Session Senate Bill 5504 → agency 291 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 5504 to Oregon Agency Expenditures agency 291'
...
joins:
- document_id: expenditures-291-fy2020
  dataset: expenditures
  key: agency=291;fiscal_year=2020
- document_id: expenditures-291-fy2021
  dataset: expenditures
  key: agency=291;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-291
- unreviewed
appropriation_document: appropriations-2019r1-sb5504
...
# 2019 Regular Session Senate Bill 5504 → agency 291

## At a glance

2019 Regular Session Senate Bill 5504 appropriates to **Department of Corrections** (budget agency code `291`, registry slug `department-of-corrections`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$835,618,026.04** of spending across 9,809 transactions and 4,416 distinct payees.
...
|---|---:|
| FY2020 | $418,465,139.09 |
| FY2021 | $417,152,886.95 |

## Provenance

- Appropriation figures: `appropriations-2019r1-sb5504` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb5504` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `department-of-corrections` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 291`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
