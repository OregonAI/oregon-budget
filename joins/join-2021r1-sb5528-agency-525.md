...
jurisdiction: oregon
id: join-2021r1-sb5528-agency-525
title: 2021 Regular Session Senate Bill 5528 → agency 525 spending, FY2022–FY2023
doc_type: dataset_doc
citation: 'Join: 2021 Regular Session Senate Bill 5528 to Oregon Agency Expenditures agency 525'
...
- agency-525
- unreviewed
appropriation_document: appropriations-2021r1-sb5528
...
# 2021 Regular Session Senate Bill 5528 → agency 525

## At a glance

2021 Regular Session Senate Bill 5528 appropriates to **Higher Education Coordinating Commission** (budget agency code `525`, registry slug `higher-education-coordinating-commission`) for the **biennium beginning 2021**, which on the stated fiscal-year convention covers **FY2022–FY2023**.
...
- Appropriation figures: `appropriations-2021r1-sb5528` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2021r1-sb5528` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `higher-education-coordinating-commission` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 525`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
