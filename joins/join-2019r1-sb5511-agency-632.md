...
jurisdiction: oregon
id: join-2019r1-sb5511-agency-632
title: 2019 Regular Session Senate Bill 5511 → agency 632 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 5511 to Oregon Agency Expenditures agency 632'
...
joins:
- document_id: expenditures-632-fy2020
  dataset: expenditures
  key: agency=632;fiscal_year=2020
- document_id: expenditures-632-fy2021
  dataset: expenditures
  key: agency=632;fiscal_year=2021
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-632
- unreviewed
appropriation_document: appropriations-2019r1-sb5511
...
# 2019 Regular Session Senate Bill 5511 → agency 632

## At a glance

2019 Regular Session Senate Bill 5511 appropriates to **Department of Geology and Mineral Industries** (budget agency code `632`, registry slug `department-of-geology-and-mineral-industries`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.

In those fiscal years that agency recorded **$6,268,725.99** of spending across 284 transactions and 97 distinct payees.
...
- Appropriation figures: `appropriations-2019r1-sb5511` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb5511` in the `oregon-legislature` corpus, referenced not copied.
