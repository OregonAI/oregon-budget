...
jurisdiction: oregon
id: join-2021r1-hb5024-agency-443
title: 2021 Regular Session House Bill 5024 → agency 443 spending, FY2022–FY2023
doc_type: dataset_doc
citation: 'Join: 2021 Regular Session House Bill 5024 to Oregon Agency Expenditures agency 443'
...
joins:
- document_id: expenditures-443-fy2022
  dataset: expenditures
  key: agency=443;fiscal_year=2022
- document_id: expenditures-443-fy2023
  dataset: expenditures
  key: agency=443;fiscal_year=2023
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-443
- unreviewed
appropriation_document: appropriations-2021r1-hb5024
...
# 2021 Regular Session House Bill 5024 → agency 443

## At a glance

2021 Regular Session House Bill 5024 appropriates to **Oregon Health Authority** (budget agency code `443`, registry slug `oregon-health-authority`) for the **biennium beginning 2021**, which on the stated fiscal-year convention covers **FY2022–FY2023**.

In those fiscal years that agency recorded **$8,656,898,812.07** of spending across 12,811 transactions and 4,451 distinct payees.
...
|---|---:|
| FY2022 | $4,337,364,011.26 |
| FY2023 | $4,319,534,800.81 |

## Provenance

- Appropriation figures: `appropriations-2021r1-hb5024` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2021r1-hb5024` in the `oregon-legislature` corpus, referenced not copied.
