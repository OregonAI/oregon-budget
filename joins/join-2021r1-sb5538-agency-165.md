...
jurisdiction: oregon
id: join-2021r1-sb5538-agency-165
title: 2021 Regular Session Senate Bill 5538 → agency 165 spending, FY2022–FY2023
doc_type: dataset_doc
citation: 'Join: 2021 Regular Session Senate Bill 5538 to Oregon Agency Expenditures agency 165'
...
joins:
- document_id: expenditures-165-fy2022
  dataset: expenditures
  key: agency=165;fiscal_year=2022
- document_id: expenditures-165-fy2023
  dataset: expenditures
  key: agency=165;fiscal_year=2023
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-165
- unreviewed
appropriation_document: appropriations-2021r1-sb5538
...
# 2021 Regular Session Senate Bill 5538 → agency 165

## At a glance

2021 Regular Session Senate Bill 5538 appropriates to **Secretary of State** (budget agency code `165`, registry slug `secretary-of-state`) for the **biennium beginning 2021**, which on the stated fiscal-year convention covers **FY2022–FY2023**.

In those fiscal years that agency recorded **$34,002,461.06** of spending across 1,013 transactions and 349 distinct payees.
...
|---|---:|
| FY2022 | $15,867,084.14 |
| FY2023 | $18,135,376.92 |

## Provenance

- Appropriation figures: `appropriations-2021r1-sb5538` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2021r1-sb5538` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `secretary-of-state` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `budget_agency_code: 165`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
