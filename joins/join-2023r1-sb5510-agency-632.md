...
jurisdiction: oregon
id: join-2023r1-sb5510-agency-632
title: 2023 Regular Session Senate Bill 5510 → agency 632 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session Senate Bill 5510 to Oregon Agency Expenditures agency 632'
...
joins:
- document_id: expenditures-632-fy2024
  dataset: expenditures
  key: agency=632;fiscal_year=2024
- document_id: expenditures-632-fy2025
  dataset: expenditures
  key: agency=632;fiscal_year=2025
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-632
- unreviewed
appropriation_document: appropriations-2023r1-sb5510
...
# 2023 Regular Session Senate Bill 5510 → agency 632

## At a glance

2023 Regular Session Senate Bill 5510 appropriates to **Department of Geology and Mineral Industries** (budget agency code `632`, registry slug `department-of-geology-and-mineral-industries`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.

In those fiscal years that agency recorded **$8,988,428.10** of spending across 430 transactions and 105 distinct payees.
...
- Appropriation figures: `appropriations-2023r1-sb5510` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-sb5510` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `department-of-geology-and-mineral-industries` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `das_agency_number: 632`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
