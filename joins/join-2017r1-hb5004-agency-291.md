...
jurisdiction: oregon
id: join-2017r1-hb5004-agency-291
title: 2017 Regular Session House Bill 5004 → agency 291 spending, FY2019–FY2019
doc_type: dataset_doc
citation: 'Join: 2017 Regular Session House Bill 5004 to Oregon Agency Expenditures agency 291'
...
joins:
- document_id: expenditures-291-fy2019
  dataset: expenditures
  key: agency=291;fiscal_year=2019
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-291
- unreviewed
appropriation_document: appropriations-2017r1-hb5004
...
# 2017 Regular Session House Bill 5004 → agency 291

## At a glance

2017 Regular Session House Bill 5004 appropriates to **Department of Corrections** (budget agency code `291`, registry slug `department-of-corrections`) for the **biennium beginning 2017**, which on the stated fiscal-year convention covers **FY2019–FY2019**.

In those fiscal years that agency recorded **$397,589,793.50** of spending across 6,022 transactions and 3,319 distinct payees.
...
|---|---:|
| FY2019 | $397,589,793.50 |

## Provenance

- Appropriation figures: `appropriations-2017r1-hb5004` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2017r1-hb5004` in the `oregon-legislature` corpus, referenced not copied.
