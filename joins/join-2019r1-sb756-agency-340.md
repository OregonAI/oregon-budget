...
jurisdiction: oregon
id: join-2019r1-sb756-agency-340
title: 2019 Regular Session Senate Bill 756 → agency 340 spending, FY2020–FY2021
doc_type: dataset_doc
citation: 'Join: 2019 Regular Session Senate Bill 756 to Oregon Agency Expenditures agency 340'
...
relationships:
  ...
  implemented_by: []
  references_external:
  - 2019 Regular Session Senate Bill 756
  related:
  - appropriations-2019r1-sb756
...
- agency-340
- unreviewed
appropriation_document: appropriations-2019r1-sb756
sibling_corpus: oregon-legislature
sibling_document_id: measure-2019r1-sb756
agency_code: '340'
...
# 2019 Regular Session Senate Bill 756 → agency 340

## At a glance

2019 Regular Session Senate Bill 756 appropriates to **Department of Environmental Quality** (budget agency code `340`, registry slug `department-of-environmental-quality`) for the **biennium beginning 2019**, which on the stated fiscal-year convention covers **FY2020–FY2021**.
...
- Appropriation figures: `appropriations-2019r1-sb756` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2019r1-sb756` in the `oregon-legislature` corpus, referenced not copied.
