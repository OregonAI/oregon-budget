...
jurisdiction: oregon
id: join-2023r1-hb5036-agency-260
title: 2023 Regular Session House Bill 5036 → agency 260 spending, FY2024–FY2025
doc_type: dataset_doc
citation: 'Join: 2023 Regular Session House Bill 5036 to Oregon Agency Expenditures agency 260'
...
relationships:
  ...
  implemented_by: []
  references_external:
  - 2023 Regular Session House Bill 5036
  related:
  - appropriations-2023r1-hb5036
...
- agency-260
- unreviewed
appropriation_document: appropriations-2023r1-hb5036
sibling_corpus: oregon-legislature
sibling_document_id: measure-2023r1-hb5036
agency_code: '260'
...
# 2023 Regular Session House Bill 5036 → agency 260

## At a glance

2023 Regular Session House Bill 5036 appropriates to **Department of State Police, Office of State Fire Marshal** (budget agency code `260`, registry slug `department-of-state-police-office-of-state-fire-marshal`) for the **biennium beginning 2023**, which on the stated fiscal-year convention covers **FY2024–FY2025**.
...
- Appropriation figures: `appropriations-2023r1-hb5036` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2023r1-hb5036` in the `oregon-legislature` corpus, referenced not copied.
- Agency identity: `department-of-state-police-office-of-state-fire-marshal` in the `executive-regulatory-frameworks` corpus, whose registry carries the hand-reviewed `budget_agency_code: 260`. Resolved here by matching this bill's `appropriated_to` string against that registry, exact-only.
- Agency identity, independently: `_meta/agency-crosswalk.yml` resolves the expenditure feed's own name for this body, `STATE FIRE MARSHAL, DEPT OF`, to the same slug on basis `das_number`. The `agency_registry_basis` in this document's frontmatter is THAT claim, about THAT string — not a description of how the bill's wording matched.
