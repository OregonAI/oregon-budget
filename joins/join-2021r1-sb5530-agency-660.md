...
jurisdiction: oregon
id: join-2021r1-sb5530-agency-660
title: 2021 Regular Session Senate Bill 5530 → agency 660 spending, FY2022–FY2023
doc_type: dataset_doc
citation: 'Join: 2021 Regular Session Senate Bill 5530 to Oregon Agency Expenditures agency 660'
...
joins:
- document_id: expenditures-660-fy2022
  dataset: expenditures
  key: agency=660;fiscal_year=2022
- document_id: expenditures-660-fy2023
  dataset: expenditures
  key: agency=660;fiscal_year=2023
relationships:
  implements: []
  implemented_by: []
  references_external:
...
- agency-660
- unreviewed
appropriation_document: appropriations-2021r1-sb5530
...
# 2021 Regular Session Senate Bill 5530 → agency 660

## At a glance

2021 Regular Session Senate Bill 5530 appropriates to **Land Conservation and Development Department** (budget agency code `660`, registry slug `land-conservation-and-development-department`) for the **biennium beginning 2021**, which on the stated fiscal-year convention covers **FY2022–FY2023**.

In those fiscal years that agency recorded **$12,207,382.42** of spending across 618 transactions and 306 distinct payees.
...
- Appropriation figures: `appropriations-2021r1-sb5530` in this corpus — machine-extracted from bill text and **not human-reviewed**.
- Bill text: `measure-2021r1-sb5530` in the `oregon-legislature` corpus, referenced not copied.
